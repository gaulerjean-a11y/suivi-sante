...
function showApiKeyStatus(saved) {
  ...
  if (saved || key) {
    ...
    el.innerHTML = '<span class="api-key-missing">⚠️ Aucune clé configurée — <a href="https://aistudio.google.com" target="_blank">Obtenir une clé gratuite sur Google AI Studio</a></span>';
  }
}
